...
return [
    'routes' => [
        ...
        ['GET', '/admin/user/new', \MadeiraMadeira\User\Controllers\Admin\UserNewAction::class],
        ['POST', '/admin/user/new', \MadeiraMadeira\User\Controllers\Admin\UserNewAction::class]
    ]
];
